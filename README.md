...
Module of **High-level programming** and **Python**, carried out during **Full Stack Software Engineering studies** at **[ALX/Holberton School](https://www.alxafrica.com/)**.
...
| ------------ | ----------- |
| [`0x00-hello_world`](h) | It aims to learn about variables, basics commands (print) and handle strings with **Python** |
